...
export async function resolveSSEResponse<TRouter extends AnyRouter>(
  opts: ResolveSSERequestOptions<TRouter, HTTPRequest>
  ...
  try {
    ...
    const result =
      /*TODO: isBatchCall ? resultEnvelopes :  */ resultEnvelopes[0]!;
    ...
    if (type === "subscription") {
      ...
      if ("error" in untransformedJSON) {
        console.error(
          ...
          JSON.stringify(untransformedJSON, null, 2)
        );
        return {
